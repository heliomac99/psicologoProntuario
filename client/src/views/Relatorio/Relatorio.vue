<template>
    <div align="center" id="content">
        ...
        <DataTable :key="dataTableKey" :colLabels="colLabels" :dataFields="dataFields" :id="'id'" :dataUrl="'http://localhost:4000/usuario/paciente/relatorios'" :paramsUrl="{ usid: 2 ,pid: codigoPaciente }" :showEditButton="true" :showRemoveButton="true" @editar="editar" @excluir="excluir" ></DataTable>
